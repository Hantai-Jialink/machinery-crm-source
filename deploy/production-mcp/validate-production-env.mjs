...
const required = [
  ...
  'CANARY_FASTGPT_ROOT_PASSWORD', 'CANARY_FASTGPT_ROOT_KEY', 'CANARY_FASTGPT_TOKEN_KEY', 'CANARY_FASTGPT_FILE_TOKEN_KEY', 'CANARY_FASTGPT_AES_KEY', 'CANARY_FASTGPT_INVOKE_TOKEN_SECRET', 'CANARY_AIPROXY_IMAGE', 'CANARY_AIPROXY_ADMIN_KEY', 'CANARY_AIPROXY_POSTGRES_PASSWORD', 'CANARY_MODEL_UPSTREAM_ENDPOINT', 'CANARY_MODEL_UPSTREAM_API_KEY',
];
