...
export default function MonthlyPlansPage() {
  ...
  const [form, setForm] = useState({ planMonth: new Date().toISOString().slice(0, 7) + "-01", name: "", description: "", items: [blank()] });
